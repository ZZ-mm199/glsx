      ...
      <div class="shp">
        <div class="shp_1">
          <div class="search_icon1">
            ...
            <router-link to="" class="shp_tex" style="color:#37ab40">个人中心</router-link>
          </div>
          <div class="shop_2">
            <img src="/img/header/shp.png" alt="" />
            <router-link to="/Shoppingcard" style="margin-left: 50px;color:#37ab40" class="shp_tex"
              >购物车</router-link
            >
          </div>
        </div>
      ...
      <div class="header_cont">
        ...
        <div class="dr float-left">
          <ul class="mb-0 clearfix">
            ...
            <li><router-link to="/" class="dr_text">限时抢购</router-link></li>
            <li><router-link to="/" class="dr_text">购物指南</router-link></li>
            <li><router-link to="/" class="dr_text">积分商城</router-link></li>
            <li><router-link to="/" class="dr_text">最新活动</router-link></li>
            <li><router-link to="/" class="dr_text">关于我们</router-link></li>
          </ul>
          <div class="dr_img">
